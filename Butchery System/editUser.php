                        ...
                        <form action="" id="form1">
                            <div id="items" style="width: 300px;" class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" required id="idNum"
                                        placeholder="Example 00-000000A00">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" required id="dateOfBirth"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" style="width: 100%; height:100%;" required
                                        name="" id="department">
                                        <option value="" disabled selected></option>
                                        <?php
...
?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" required id="cpwd"
